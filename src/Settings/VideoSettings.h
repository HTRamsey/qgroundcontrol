...
public:
    ...
    QString rtspVideoSource() const { return videoSourceRTSP; }
    QString udp264VideoSource() const { return videoSourceUDPH264; }
    QString udp265VideoSource() const { return videoSourceUDPH265; }
    QString tcpVideoSource() const { return videoSourceTCP; }
    QString mpegtsVideoSource() const { return videoSourceMPEGTS; }
    QString disabledVideoSource() const { return videoDisabled; }
...
private slots:
    void _configChanged(const QVariant &value);
