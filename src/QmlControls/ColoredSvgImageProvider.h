...
/// Image provider that rasterizes an SVG (or any QImage-loadable file) and
/// recolors its alpha mask with a caller-supplied tint, avoiding the need
/// for a runtime ColorOverlay shader.
///
/// URL format: image://coloredsvg/<resource-or-fs-path>?color=<RRGGBB|AARRGGBB>
