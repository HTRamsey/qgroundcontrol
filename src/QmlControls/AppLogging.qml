                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        QGCMouseArea {
                            ...
                            QGCToolTip {
                                text: qsTr("Disk Logging: %1").arg(qgcLogging.diskLoggingEnabled ? qsTr("On") : qsTr("Off"))
                            }
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        QGCMouseArea {
                            ...
                            QGCToolTip {
                                text: qsTr("Remote Logging: %1").arg(qgcLogging.remoteLoggingEnabled ? qsTr("On") : qsTr("Off"))
                            }
                        }
                    }
                }
