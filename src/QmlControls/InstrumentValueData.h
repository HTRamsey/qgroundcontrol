...
public:
    ...
    Q_INVOKABLE void clearFact();
    Q_INVOKABLE static bool isValidColor(const QColor &color) const { return color.isValid(); }
    Q_INVOKABLE static QColor invalidColor() { return QColor(); }
    Q_INVOKABLE void addRangeValue();
    Q_INVOKABLE void removeRangeValue(int index);

    QStringList factGroupNames() const;
    QStringList factValueNames() const;
    QString factGroupName() const { return _factGroupName; }
    QString factName() const { return _factName; }
    Fact *fact() const { return _fact; }
    QString text() const { return _text; }
    bool showUnits() const { return _showUnits; }
    QString icon() const { return _icon; }
    RangeType rangeType() const { return _rangeType; }
    QVariantList rangeValues() const { return _rangeValues; }
    QVariantList rangeColors() const { return _rangeColors; }
    QVariantList rangeIcons() const { return _rangeIcons; }
    QVariantList rangeOpacities() const { return _rangeOpacities; }
...
private slots:
    void _resetRangeInfo();
    void _updateRanges();
    void _vehicleChanged();
    void _lookForMissingFact();
...
private:
    ...
    const QStringList _rangeTypeNames = {
