...
class FirmwareImage;
class FirmwareUpgradeStateMachine;
class Fact;
...
private:
    ...
    uint32_t    _bootloaderBoardID = 0;         ///< Board ID
    uint32_t    _bootloaderBoardFlashSize = 0;  ///< Flash size in bytes of board
    ...
    /// @brief State machine for firmware upgrade workflow
