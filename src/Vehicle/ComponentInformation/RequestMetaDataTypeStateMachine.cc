...
#include "states/AsyncFunctionState.h"
#include "states/SkippableAsyncState.h"
#include "states/FunctionState.h"
#include "states/QGCFinalState.h"
...
void RequestMetaDataTypeStateMachine::_createStates()
{
    ...
    _stateRequestCompInfo = addAsyncFunctionState(
        "RequestCompMetadata",
    ...
    _stateRequestMetaDataJson = addAsyncFunctionState(
        "RequestMetaDataJson",
    ...
    _stateRequestTranslationJson = addAsyncFunctionState(
...
void RequestMetaDataTypeStateMachine::_wireTransitions()
{
    ...
    _stateRequestCompInfo->addTransition(_stateRequestCompInfo, &AsyncFunctionState::advance, _stateRequestDeprecated);

    // RequestDeprecated -> RequestMetaDataJson (either via advance or skipped)
    _stateRequestDeprecated->addTransition(_stateRequestDeprecated, &SkippableAsyncState::advance, _stateRequestMetaDataJson);
    ...
    _stateRequestMetaDataJson->addTransition(_stateRequestMetaDataJson, &AsyncFunctionState::advance, _stateRequestMetaDataJsonFallback);

    // RequestMetaDataJsonFallback -> RequestTranslationJson
    _stateRequestMetaDataJsonFallback->addTransition(_stateRequestMetaDataJsonFallback, &SkippableAsyncState::advance, _stateRequestTranslationJson);
    ...
    _stateRequestTranslationJson->addTransition(_stateRequestTranslationJson, &AsyncFunctionState::advance, _stateRequestTranslate);

    // RequestTranslate -> CompleteRequest
    _stateRequestTranslate->addTransition(_stateRequestTranslate, &SkippableAsyncState::advance, _stateComplete);
    _stateRequestTranslate->addTransition(_stateRequestTranslate, &SkippableAsyncState::skipped, _stateComplete);

    // CompleteRequest -> Final
...
{
    qCDebug(RequestMetaDataTypeStateMachineLog) << "_httpDownloadComplete remoteFile:localFile:errorMsg" << remoteFile << localFile << errorMsg;
    ...
    if (errorMsg.isEmpty()) {
        ...
        qCWarning(RequestMetaDataTypeStateMachineLog) << "_httpDownloadComplete failed remoteFile:localFile:errorMsg" << remoteFile << localFile << errorMsg;
    }
