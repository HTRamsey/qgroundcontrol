...
public:
    ...
    virtual QList<VehicleComponent*> componentsForVehicle(AutoPilotPlugin *vehicle) const;
    ...
    virtual QList<MAV_CMD> supportedMissionCommands(QGCMAVLink::VehicleClass_t /*vehicleClass*/) const { QList<MAV_CMD>(); }
    ...
    virtual void updateAvailableFlightModes(const FlightModeList &modeList) { _updateModeMappings(modeList); }
...
protected:
    ...
    void _setModeEnumToModeStringMapping(const FlightModeCustomModeMap &enumToString) { _modeEnumToString = enumToString; }
