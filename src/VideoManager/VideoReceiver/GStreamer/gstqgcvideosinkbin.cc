...
{
    GObjectClass *const gobject_klass = reinterpret_cast<GObjectClass*>(klass);
    GstElementClass *const gstelement_klass = reinterpret_cast<GstElementClass*>(klass);
    ...
    g_object_class_install_property(G_OBJECT_CLASS(klass), PROP_ENABLE_LAST_SAMPLE,
    ...
    g_object_class_install_property(G_OBJECT_CLASS(klass), PROP_LAST_SAMPLE,
        g_param_spec_boxed(PROP_LAST_SAMPLE_NAME, "Last Sample",
            "The last sample received in the sink", GST_TYPE_SAMPLE,
            static_cast<GParamFlags>(G_PARAM_READABLE | G_PARAM_STATIC_STRINGS)));

    g_object_class_install_property(G_OBJECT_CLASS(klass), PROP_WIDGET,
        g_param_spec_pointer(PROP_WIDGET_NAME, "QQuickItem",
            "The QQuickItem to place in the object hierarchy",
            static_cast<GParamFlags>(G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS)));

    g_object_class_install_property(G_OBJECT_CLASS(klass), PROP_FORCE_ASPECT_RATIO,
        g_param_spec_boolean(PROP_FORCE_ASPECT_RATIO_NAME, "Force aspect ratio",
            "When enabled, scaling will respect original aspect ratio",
            DEFAULT_FORCE_ASPECT_RATIO,
            static_cast<GParamFlags>(G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS)));

    g_object_class_install_property(G_OBJECT_CLASS(klass), PROP_PIXEL_ASPECT_RATIO,
...
// {
//     GST_DEBUG_CATEGORY_INIT(GST_CAT_DEFAULT, "qgcvideosinkbin", 0, "QGC Video Sink Bin");
//     return gst_element_register(plugin, "qgcvideosinkbin", GST_RANK_NONE, GST_TYPE_QGC_VIDEO_SINK_BIN);
// }
