...
void APMAutoPilotPlugin::_checkForBadCubeBlack()
{
    ...
    const QString paramAcc3("INS_ACC3_ID");
    const QString paramGyr3("INS_GYR3_ID");
    const QString paramEnableMask("INS_ENABLE_MASK");
