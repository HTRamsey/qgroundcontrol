...
public:
    ...
    virtual QStringList cameraLabels() const { return _cameraLabels; }  ///< Camera names to show the user (for selection)
    virtual int currentCamera() const { return _currentCameraIndex; }   ///< Current selected camera
...
protected:
    class CameraStruct
    {
        Q_GADGET
    public:
        CameraStruct(uint8_t compID_, const Vehicle *vehicle);
