...
///
/// // Generate WKT string
/// QString wkt = WKTHelper::toWKT(polygon);
/// @endcode
///
...
public:
    ...
    static bool parsePoint(const QString &wkt, QGeoCoordinate &coord, QString &errorString);
    ...
    /// @param[out] errorString Error description if parsing fails
    /// @return true on success
    static bool parseMultiPoint(const QString &wkt, QList<QGeoCoordinate> &points, QString &errorString);
    ...
    /// @param[out] errorString Error description if parsing fails
    /// @return true on success
    static bool parseLineString(const QString &wkt, QList<QGeoCoordinate> &coords, QString &errorString);
    ...
    /// @param[out] errorString Error description if parsing fails
    /// @return true on success
    static bool parseMultiLineString(const QString &wkt, QList<QList<QGeoCoordinate>> &polylines, QString &errorString);
    ...
    /// @param[out] errorString Error description if parsing fails
    /// @return true on success
    static bool parsePolygon(const QString &wkt, QList<QGeoCoordinate> &vertices, QString &errorString);
    ...
    /// @param[out] errorString Error description if parsing fails
    /// @return true on success
    static bool parsePolygonWithHoles(const QString &wkt, QGeoPolygon &polygon, QString &errorString);
    ...
    /// @param[out] errorString Error description if parsing fails
    /// @return true on success
    static bool parseMultiPolygon(const QString &wkt, QList<QList<QGeoCoordinate>> &polygons, QString &errorString);
    ...
    /// @param[out] errorString Error description if parsing fails
    /// @return true on success
    static bool parseMultiPolygonWithHoles(const QString &wkt, QList<QGeoPolygon> &polygons, QString &errorString);
    ...
    /// @return true on success
    static bool loadPointFromFile(const QString &filePath, QGeoCoordinate &coord, QString &errorString);
    ...
    /// @param[out] errorString Error description if load fails
    /// @return true on success
    static bool loadPointsFromFile(const QString &filePath, QList<QGeoCoordinate> &points, QString &errorString);
    ...
    /// @param[out] errorString Error description if load fails
    /// @return true on success
    static bool loadPolylineFromFile(const QString &filePath, QList<QGeoCoordinate> &coords, QString &errorString);
    ...
    /// @return true on success
    static bool loadPolylinesFromFile(const QString &filePath, QList<QList<QGeoCoordinate>> &polylines,
    ...
    /// @param[out] errorString Error description if load fails
    /// @return true on success
    static bool loadPolygonFromFile(const QString &filePath, QList<QGeoCoordinate> &vertices, QString &errorString);
    ...
    /// @return true on success
    static bool loadPolygonsFromFile(const QString &filePath, QList<QList<QGeoCoordinate>> &polygons,
                                      QString &errorString, bool loadAll = true);
    ...
    /// @return WKT string
    static QString toWKTPoint(const QGeoCoordinate &coord, bool includeAltitude = false);

    /// Generate WKT MULTIPOINT string
    /// @param points Points to convert
    /// @param includeAltitude Include Z coordinates if available
    /// @return WKT string
    static QString toWKTMultiPoint(const QList<QGeoCoordinate> &points, bool includeAltitude = false);

    /// Generate WKT LINESTRING string
    /// @param coords Coordinates to convert
    /// @param includeAltitude Include Z coordinates if available
    /// @return WKT string
    static QString toWKTLineString(const QList<QGeoCoordinate> &coords, bool includeAltitude = false);

    /// Generate WKT MULTILINESTRING string
    /// @param polylines Polylines to convert
    /// @param includeAltitude Include Z coordinates if available
    /// @return WKT string
    static QString toWKTMultiLineString(const QList<QList<QGeoCoordinate>> &polylines, bool includeAltitude = false);

    /// Generate WKT POLYGON string
    /// @param vertices Polygon vertices (will be auto-closed)
    /// @param includeAltitude Include Z coordinates if available
    /// @return WKT string
    static QString toWKTPolygon(const QList<QGeoCoordinate> &vertices, bool includeAltitude = false);

    /// Generate WKT POLYGON string with holes
    /// @param polygon QGeoPolygon with holes
    /// @param includeAltitude Include Z coordinates if available
    /// @return WKT string
    static QString toWKTPolygon(const QGeoPolygon &polygon, bool includeAltitude = false);

    /// Generate WKT MULTIPOLYGON string
    /// @param polygons List of polygon vertices
    /// @param includeAltitude Include Z coordinates if available
    /// @return WKT string
    static QString toWKTMultiPolygon(const QList<QList<QGeoCoordinate>> &polygons, bool includeAltitude = false);

    /// Generate WKT MULTIPOLYGON string with holes
    /// @param polygons List of QGeoPolygon with holes
    /// @param includeAltitude Include Z coordinates if available
    /// @return WKT string
    static QString toWKTMultiPolygon(const QList<QGeoPolygon> &polygons, bool includeAltitude = false);
    ...
    /// @param includeAltitude Include Z coordinate if available
    /// @return true on success
    static bool savePointToFile(const QString &filePath, const QGeoCoordinate &coord,
    ...
    /// @param includeAltitude Include Z coordinates if available
    /// @return true on success
    static bool savePointsToFile(const QString &filePath, const QList<QGeoCoordinate> &points,
                                  QString &errorString, bool includeAltitude = false);
    ...
    /// @param includeAltitude Include Z coordinates if available
    /// @return true on success
    static bool savePolylineToFile(const QString &filePath, const QList<QGeoCoordinate> &coords,
                                    QString &errorString, bool includeAltitude = false);
    ...
    /// @param includeAltitude Include Z coordinates if available
    /// @return true on success
    static bool savePolylinesToFile(const QString &filePath, const QList<QList<QGeoCoordinate>> &polylines,
                                     QString &errorString, bool includeAltitude = false);
    ...
    /// @param includeAltitude Include Z coordinates if available
    /// @return true on success
    static bool savePolygonToFile(const QString &filePath, const QList<QGeoCoordinate> &vertices,
                                   QString &errorString, bool includeAltitude = false);
    ...
    /// @param includeAltitude Include Z coordinates if available
    /// @return true on success
    static bool savePolygonsToFile(const QString &filePath, const QList<QList<QGeoCoordinate>> &polygons,
                                    QString &errorString, bool includeAltitude = false);
    ...
    static QString geometryType(const QString &wkt);

    /// Check if a WKT string includes Z (altitude) values
    /// @param wkt WKT string
    /// @return true if the geometry type includes Z modifier
    static bool hasAltitude(const QString &wkt);

private:
    static bool parseCoordinateList(const QString &coordStr, QList<QGeoCoordinate> &coords,
                                     bool hasZ, QString &errorString);
    static bool parseRing(const QString &ringStr, QList<QGeoCoordinate> &coords,
                          bool hasZ, QString &errorString);
    static QString coordToString(const QGeoCoordinate &coord, bool includeAltitude);
    static QString coordListToString(const QList<QGeoCoordinate> &coords, bool includeAltitude, bool closeRing);
};
