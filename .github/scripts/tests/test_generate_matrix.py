...
def test_generate_matrix_invalid_platform_raises(sample_config: dict) -> None:
    with pytest.raises(ValueError, match="Unknown platform"):
        generate_matrix(sample_config, "freebsd")


def test_generate_matrix_empty_variants_raises() -> None:
    config = {"platforms": {"test": {"variants": []}}}
    with pytest.raises(ValueError, match="No variants configured"):
        generate_matrix(config, "test")
