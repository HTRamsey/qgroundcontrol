...
Item {
    ...
    property var    _paramLosPolygon /* NextVision */
    ...
    property var    _losCoords:                 QGroundControl.multiVehicleManager.activeVehicle.losCoords  //NextVision
    ...
    Component.onCompleted: {
        ...
        _paramLosPolygon = paramLosPolygon.createObject(map) /* NextVision */
        map.addMapItem(_paramCircleFenceComponent)
        map.addMapItem(_paramLosPolygon) /* NextVision */
    }
    ...
    Component.onDestruction: {
        ...
        _paramLosPolygon.destroy() /* NextVision */
    }
