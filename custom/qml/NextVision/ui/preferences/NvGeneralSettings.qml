...
Rectangle {
    ...
    property var  _nextVisionSettings:                  QGroundControl.settingsManager.nextVisionSettings
    property Fact _virtualCamJoystick:                  _nextVisionSettings.virtualCamJoystick
    property Fact _virtualCamJoystickShowZoom:          _nextVisionSettings.virtualCamJoystickShowZoom
    property Fact _telemValuesBarLocation:              _nextVisionSettings.telemetryValuesBarLocation
    property Fact _showFullScreenButton:                _nextVisionSettings.showFullScreenButton
    property Fact _font_size:                           _nextVisionSettings.camControlFontSize
    property Fact _quick_mode:                          _nextVisionSettings.quickViewMode
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                FactCheckBox {
                                    text:       qsTr("Virtual Cam Joystick")
                                    visible:    _virtualCamJoystick.visible
                                    fact:       _virtualCamJoystick
                                }

                                FactCheckBox {
                                    text:       qsTr("Show Cam Zoom")
                                    visible:    _virtualCamJoystickShowZoom.visible
                                    enabled:    _virtualCamJoystick.rawValue
                                    fact:       _virtualCamJoystickShowZoom
                                }
                            }
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    id:         _camControlFontSizeLabel
                                    text:       qsTr("Camera Control Font Size")
                                    visible:    _camControlFontSizeCombobox.visible
                                }

                                FactComboBox {
                                    id:                     _camControlFontSizeCombobox
                                    Layout.preferredWidth:  _comboFieldWidth
                                    indexModel:             false
                                    fact:                   _font_size
