...
Item {
    ...
    readonly property string changeAltTitle:                qsTr("Altitude")
    ...
    readonly property string remoteIdTitle:                 qsTr("Remote ID")
    readonly property string spotlightTitle:                qsTr("Spotlight")
    ...
    readonly property string remoteIdMessage:                   qsTr("Remote ID")
    readonly property string spotlightMessage:                  qsTr("Spotlight")
    ...
    property bool showSetHome:              false // _guidedActionsEnabled
    ...
    property bool showRemoteId:             _guidedActionsEnabled && _corePlugin.drone.remoteIdEnabled.rawValue
    property bool showSpotlight:            _guidedActionsEnabled && _corePlugin.drone.spotlightEnabled.rawValue
    ...
    function confirmAction(actionCode, actionData, mapIndicator) {
        ...
        case actionAntiCollisionLight:
            ...
            break
        case actionBeacon:
            confirmDialog.title = beaconTitle
            confirmDialog.message = beaconMessage
            break
        case actionNavigationLight:
            confirmDialog.title = navigationLightTitle
            confirmDialog.message = navigationLightMessage
            break
        case actionRemoteId:
            confirmDialog.title = remoteIdTitle
