...
static void mavlink_test_zat_gpu_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_zat_gpu_data_t packet_in = {
        963497464,963497672,73.0,101.0,129.0,18275,18379,18483,211,22,89,156,223,34,101,168,235,46,113,180,247,58
    };
    mavlink_zat_gpu_data_t packet1, packet2;
        ...
        packet1.psuHighPower = packet_in.psuHighPower;
        packet1.satsInUse = packet_in.satsInUse;
        packet1.gpsFixType = packet_in.gpsFixType;
        packet1.gpsFixMode = packet_in.gpsFixMode;
        packet1.gpsIsValid = packet_in.gpsIsValid;
