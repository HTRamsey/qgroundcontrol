...
elseif(ANDROID)
    ...
    set(GSTREAMER_EXTRA_DEPS gstreamer-base-1.0 gstreamer-video-1.0 gstreamer-gl-1.0 gstreamer-gl-prototypes-1.0 gstreamer-rtsp-1.0)
    ...
    elseif(IOS)
        ...
        list(APPEND GSTREAMER_PLUGINS va)
    endif()
...
################################################################################
    ...
    if(GStreamer_USE_STATIC_LIBS)
        ...
        if(ANDROID)
            list(APPEND GSTREAMER_PLUGINS gstandroidmedia)
        elseif(IOS)
            list(APPEND GSTREAMER_PLUGINS gstapplemedia)
        else()
            list(APPEND GSTREAMER_PLUGINS gstva)
        endif()
