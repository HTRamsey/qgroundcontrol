function(download_gstreamer version)
	...
	if(ANDROID)
		...
		if(${CMAKE_ANDROID_ARCH_ABI} STREQUAL armeabi-v7a)
            set(GSTREAMER_ROOT ${gstreamer_SOURCE_DIR}/armv7 CACHE INTERNAL "")
        elseif(${CMAKE_ANDROID_ARCH_ABI} STREQUAL arm64-v8a)
            set(GSTREAMER_ROOT ${gstreamer_SOURCE_DIR}/arm64 CACHE INTERNAL "")
        elseif(${CMAKE_ANDROID_ARCH_ABI} STREQUAL x86)
            set(GSTREAMER_ROOT ${gstreamer_SOURCE_DIR}/x86 CACHE INTERNAL "")
        elseif(${CMAKE_ANDROID_ARCH_ABI} STREQUAL x86_64)
            set(GSTREAMER_ROOT ${gstreamer_SOURCE_DIR}/x86_64 CACHE INTERNAL "")
        endif()
	endif()
	...
	if(NOT LINUX)
		...
		set(GST_QT6_PLUGIN_PATH ${gstreamer_good_plugins_SOURCE_DIR}/ext/qt6 CACHE INTERNAL "")
	endif()
endfunction()
