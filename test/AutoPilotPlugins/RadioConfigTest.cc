...
void RadioConfigTest::_beginCalibration()
{
...
void RadioConfigTest::_fullCalibration_px4_test()
{
    _fullCalibrationWorker(MAV_AUTOPILOT_PX4);
}

void RadioConfigTest::_fullCalibration_apm_test()
{
    _fullCalibrationWorker(MAV_AUTOPILOT_ARDUPILOTMEGA);
}

void RadioConfigTest::_channelHomePosition()
{
...
void RadioConfigTest::_validateParameters()
{
...
bool RadioConfigTest::_px4Vehicle() const
{
    return _vehicle->firmwareType() == MAV_AUTOPILOT_PX4;
}

const struct RadioConfigTest::ChannelSettings* RadioConfigTest::_channelSettings() const
{
    return _px4Vehicle() ? _rgChannelSettingsPX4 : _rgChannelSettingsAPM;
}

const struct RadioConfigTest::ChannelSettings* RadioConfigTest::_channelSettingsValidate() const
{
    return _px4Vehicle() ? _rgChannelSettingsValidatePX4 : _rgChannelSettingsValidateAPM;
}

const struct RadioComponentController::FunctionInfo* RadioConfigTest::_functionInfo() const
{
    return _px4Vehicle() ? RadioComponentController::_rgFunctionInfoPX4 : RadioComponentController::_rgFunctionInfoAPM;
}

int RadioConfigTest::_chanMax() const
{
